...
function PlayerCardsAlternate({ player, winners_cards, on_new_table_state, ...props }) {
    ...
    const [cardGap, setCardGap] = useState(card_width +partial_visible_card_width); // in pixels
...
export default PlayerCardsAlternate;
